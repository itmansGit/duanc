					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="col-sm-offset-1 col-sm-10">
								<div class="space"></div>
								<form:form class="form-horizontal" enctype="multipart/form-data" method="post" 
									action="${ctx }/authc/phone-entry-submit?menuId=${menuId }&subMenuId=${subMenuId }" id="submit-form" commandName="phoneDTO">
									<div class="tabbable">
											...
											<div id="edit-basic" class="tab-pane in active">
												...
												<div class="row">
													<div class="col-sm-offset-2  col-xs-12 col-sm-3">
														...
														<img alt="" src="" width="180" height="180" id="img">
													</div>
													<div class="col-xs-12 col-sm-6">
															...
															<div class="col-sm-6">
																<form:select path="modelId" cssClass="input-large">
																	<form:option value="" label="请选择"/>
																		<c:if test="${phoneDTO.brandId != null}">
																			<spring:eval expression="@brandAndModelService.getModelMapByBrand('${phoneDTO.brandId }')" var="models"/>
														...
														<div class="form-group">
															...
															<div class="col-sm-8">
																<form:input path="version" class="input-large" placeholder="版本：联通3g版"/>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-xs-12 col-sm-6">
														<div class="form-group">
															<label class="col-sm-4 control-label no-padding-right">上市日期</label>
															<div class="col-sm-8">
																<div class="input-medium">
																	<div class="input-group">
																		<form:input path="listingDate" class="date-picker" 
												...
												<div class="space"></div>
												<h4 class="header blue bolder smaller">CPU</h4>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right">CPU型号</label>
													<div class="col-sm-9">
														<form:input path="cpu" placeholder="海思" class="input-large"/>
													</div>
												</div>
												<div class="space-4"></div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right">CPU核心数</label>
													<div class="col-sm-9">
														<form:input path="cpuCores" placeholder="四核" class="input-large"/>
													</div>
												</div>
												<div class="space-4"></div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right">CPU频率</label>
													<div class="col-sm-8">
														<div class="input-medium">
															<div class="input-group">
																<form:input path="cpuHz" placeholder="1.7"/>
												...
												<div class="space"></div>
												<h4 class="header blue bolder smaller">内存</h4>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" >RAM</label>
													<div class="col-sm-8">
														<div class="input-medium">
															<div class="input-group">
																<form:input path="ram" placeholder="3.0"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<div class="input-medium">
															<div class="input-group">
																<form:input path="rom" placeholder="16"/>
																<span class="input-group-addon">G</span>
															</div>
														</div>
													</div>
												</div>
												<h4 class="header blue bolder smaller">其他</h4>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" >主屏尺寸</label>
													<div class="col-sm-8">
														<div class="input-medium">
															<div class="input-group">
																<form:input path="screenSize" placeholder="4.5"/>
																<span class="input-group-addon">寸</span>
															</div>
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<form:input path="os" class="input-large" placeholder="Android"/>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right">网络类型</label>
													<div class="col-sm-9">
														<form:input path="netType" class="input-large" placeholder="WCDMA 4G / 4G"/>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" >电池容量</label>
													<div class="col-sm-8">
														<div class="input-medium">
															<div class="input-group">
																<form:input path="batteryCapacity" placeholder="3000"/>
