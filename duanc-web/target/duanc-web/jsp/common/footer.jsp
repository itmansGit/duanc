...
<footer data-am-widget="footer" class="am-footer am-footer-default" data-am-footer="{  }" style="background-color: #EBF3DF;">
  <div class="am-footer-switch">
    ...
    href="javascript:">其他版本</a>
  </div>
  <div class="am-footer-miscs ">
    <p>由
      <a href="#" title="段超" target="_blank" class="">段超</a>提供技术支持</p>
    <p>CopyRight©2015 duanc Inc.</p>
    <p>京ICP备13033158</p>
  </div>
</footer>
